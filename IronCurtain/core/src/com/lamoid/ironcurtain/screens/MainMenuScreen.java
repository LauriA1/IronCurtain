...
public class MainMenuScreen implements Screen {
    ...
    public void show() {
        ...
        TextButton play_button = new TextButton(game.stringsBundle.get("play"), game.skin);
        TextButton settings_button = new TextButton(game.stringsBundle.get("settings"), game.skin);
        TextButton exit_button = new TextButton(game.stringsBundle.get("exit"), game.skin);
