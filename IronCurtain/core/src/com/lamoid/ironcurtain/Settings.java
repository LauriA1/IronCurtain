...
public class Settings {
    ...
    private static final String PREF_SHAKE_ENABLED = "shakeEnabled";
    ...
    public boolean isShakeEnabled() {
        return getPrefs().getBoolean(PREF_SHAKE_ENABLED, true);
    }

    public void setShakeEnabled(boolean shakeEnabled) {
        getPrefs().putBoolean(PREF_SHAKE_ENABLED, shakeEnabled);
        getPrefs().flush();
    }
}
